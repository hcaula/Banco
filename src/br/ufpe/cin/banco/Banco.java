...
public class Banco {
	...
	public void creditar(String numero, double valor) throws ContaNaoEncontradaException, OperacaoComValoresNegativoException {
		ContaAbstrata c = contas.procurar(numero);
		c.creditar(valor);
	}

	public void debitar(String numero, double valor) throws ContaNaoEncontradaException, SaldoInsuficienteException, OperacaoComValoresNegativoException {
		ContaAbstrata c = contas.procurar(numero);
		c.debitar(valor);
	}
	...
	public void transferir(String de, String para, double valor) throws ContaNaoEncontradaException, SaldoInsuficienteException, OperacaoComValoresNegativoException {
	...
	public void renderJuros(String numero) throws ContaNaoEncontradaException, RenderJurosPoupancaException, OperacaoComValoresNegativoException {
		ContaAbstrata c = contas.procurar(numero);
	...
	public void renderBonus(String numero) throws ContaNaoEncontradaException, RenderBonusContaEspecialException, OperacaoComValoresNegativoException {
		ContaAbstrata c = contas.procurar(numero);
