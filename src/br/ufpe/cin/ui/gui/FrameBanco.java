...
public class FrameBanco extends JFrame {
	...
	private void erroNumero() {
		erroNumero("Informe o n�mero da conta desejada");
	}
	...
	private void initialize() {
		...
		this.setTitle("Aplica��o Banc�ria");
	}
	...
	private JTextField getTf_numero() {
		if (tf_numero == null) {
			...
			tf_numero.setToolTipText("N�mero da conta a ser operada (se transferencia, conta de origem)");
